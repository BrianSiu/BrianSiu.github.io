...
<body>
    ...
    <a href = "http://localhost:8888/Collection1.php" id = "triangle"></a> 
    <script>

        // Walsh, David. "Camera and Video Control with HTML5." Camera and Video Control 
     // with HTML5. N.p., n.d. Web. 4 Jan. 2015. <http://davidwalsh.name/ 
     // browser-camera>. 
...
document.getElementById("download").addEventListener('click', function () {
    downloadCanvas(this, 'canvas', 'shirt.png');
}, false);
